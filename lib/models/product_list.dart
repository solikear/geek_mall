...
@JsonSerializable()
  ...
  Content(this.id,this.title,this.skus,this.description,this.cate,this.status,this.postFee,this.createTime,this.image,this.banners,);
